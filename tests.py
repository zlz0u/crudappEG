...
from crudApp import create_app, db
from crudApp.models import Employee, Department, Role
...
class TestBase(TestCase):
	def create_app(self):
		...
		app.config.update(SQLALCHEMY_DATABASE_URI="postgresql://cruduser:crudpassword@localhost/crudappdb_test")
		return app
